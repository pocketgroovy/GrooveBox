...
public class RadioTwit extends Activity {
	...
	JSONArray json;
	private static JSONObject latest,latest2,latest3,latest4,latest5;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.radio_twit);
	...
	public JSONArray latestTweet(String username) throws ClientProtocolException, IOException, JSONException
	{
		...
		if(status == 200){
			...
			Toast.makeText(RadioTwit.this, "Error", Toast.LENGTH_SHORT).show();
		...
		public class Read extends AsyncTask<String, Integer, JSONArray>{
			...
			protected JSONArray doInBackground(String... params) {
				...
				try {
					return json = latestTweet("radiohead");
