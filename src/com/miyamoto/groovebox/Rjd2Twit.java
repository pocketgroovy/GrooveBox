...
public class Rjd2Twit extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rj_twit);
	...
	public JSONArray latestTweet(String username) throws ClientProtocolException, IOException, JSONException
	{
		...
		if(status == 200){
			...
			Toast.makeText(Rjd2Twit.this, "Error", Toast.LENGTH_SHORT).show();
