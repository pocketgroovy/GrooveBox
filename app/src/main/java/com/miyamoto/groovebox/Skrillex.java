...
public class Skrillex extends Activity implements Runnable {
	...
	private static Integer[] skPic = { R.drawable.sk, R.drawable.sk2,
			R.drawable.sk3, R.drawable.sk4, R.drawable.sk5 };

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.skrillex);
		Gallery radioPhotos = (Gallery) findViewById(R.id.skGallery);
	...
	public static class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			pic.setImageResource(skPic[position]);
	...
	protected void onStart() {
		...
		mp = MediaPlayer.create(this, R.raw.skrillex_remix1); // remix1 player
		mp.setLooping(true);
		...
		mp2 = MediaPlayer.create(this, R.raw.skrillex_remix2); // remix1 player
		mp2.setLooping(true);
	...
	public void onClickV(View v) {
		...
		if (mp.isPlaying()) {
			...
			i.putExtra("myDrawable", R.drawable.skrillex_remix1);
			visualizerWindow.mp = mp;

		} else {
			int audioID2 = mp2.getAudioSessionId();
			i.putExtra("audio", audioID2);
			i.putExtra("myDrawable", R.drawable.skrillex_remix2);
