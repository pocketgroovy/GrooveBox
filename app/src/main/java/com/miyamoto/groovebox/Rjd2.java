...
public class Rjd2 extends Activity implements Runnable {
	...
	private static Integer[] rjd2Pic = { R.drawable.rj, R.drawable.rj2,
			R.drawable.rj3, R.drawable.rj4, R.drawable.rj5 };

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.rjd2);

		Gallery radioPhotos = (Gallery) findViewById(R.id.rjd2Gallery);
	...
	public static class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			pic.setImageResource(rjd2Pic[position]);
	...
	protected void onStart() {
		...
		mp = MediaPlayer.create(this, R.raw.rjd2_remix1); // remix1 player
		mp.setLooping(true);
		...
		mp2 = MediaPlayer.create(this, R.raw.rjd2_remix2); // remix1 player
		mp2.setLooping(true);
	...
	public void onClickV(View v) {
		...
		if (mp.isPlaying()) {
			...
			i.putExtra("myDrawable", R.drawable.rjd2_remix1);
			visualizerWindow.mp = mp;

		} else {
			int audioID2 = mp2.getAudioSessionId();
			i.putExtra("audio", audioID2);
			i.putExtra("myDrawable", R.drawable.rjd2_remix2);
